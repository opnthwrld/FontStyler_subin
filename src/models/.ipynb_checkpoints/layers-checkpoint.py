...
class Encoder_conv_8(nn.Module):
    ...
    def __init__(self, img_dim=1, conv_dim=64):
        ...
        self.conv5 = conv2d(conv_dim * 8, 8)
...
class Decoder_conv_8(nn.Module):

    def __init__(self, img_dim=1, embedded_dim=156, conv_dim=64):
        super().__init__()
...
class Encoder_conv_only_cat(nn.Module):
...
class Decoder_conv_only_cat(nn.Module):

    def __init__(self, img_dim=1, embedded_dim=28, conv_dim=64):
        super().__init__()
        self.deconv1 = deconv2d(embedded_dim, conv_dim * 8, k_size=4, dilation=2, stride=2)
        self.deconv2 = deconv2d(conv_dim * 8, conv_dim * 4, k_size=4, dilation=2, stride=2)
        self.deconv3 = deconv2d(conv_dim * 4, conv_dim * 2, k_size=6, dilation=2, stride=4)
...
class Decoder_conv_variational(nn.Module):
    ...
    def __init__(self, img_dim=1, embedded_dim=640, conv_dim=128):
        ...
        self.fc2conv = nn.Linear(conv_dim + 20 + 128, conv_dim * 8)
    ...
    def forward(self, embedded):
        # |embedded| = (batch, conv_dim + 20+ 128)
